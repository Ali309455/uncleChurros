  ...
  switch (icon) {
    case "sparkle":
      return (
        <svg {...common}>
          <path
            d="M12 2c.7 4.9 3.5 7.8 8.5 8.8-5 1-7.8 3.9-8.5 8.8-.7-4.9-3.5-7.8-8.5-8.8 5-1 7.8-3.9 8.5-8.8z"
            fill="currentColor"
            stroke="none"
          />
        </svg>
...
function BundleCard({ bundle, price, parkPrice, featured, onAdd }) {
  ...
  return (
    <RevealBlock delay={bundle.dozens * 0.08} className="h-full">
      <div
        className={`relative h-full flex flex-col rounded-3xl p-6 sm:p-8 transition-all duration-300 ${
          featured
      ...
      >
        ...
        <p className="text-[10px] font-semibold uppercase tracking-[0.22em] text-navy-600">
          {bundle.dozens === 1 ? "One" : bundle.dozens === 2 ? "Two" : "Three"}{" "}
          Dozen
        </p>
        <p
        ...
        <div className="mt-4 rounded-xl bg-green-50 border border-green-600/20 px-3.5 py-2.5 flex items-center justify-between">
          <span className="text-[12px] font-semibold text-green-700/90">
            Save ${save.toFixed(2)}
          </span>
          <span className="text-[12px] text-charcoal-700/40 line-through">
            ${parkTotal.toFixed(2)}
          </span>
        </div>
        <button
...
const testimonials = [
  {
    quote:
      "I've been to Disneyland twelve times. These taste better. I'm not sure how to feel about that.",
    author: "Priya D., Austin TX",
  },
  {
    quote:
      "Showed up for my daughter's birthday with a box. I am now her favourite parent. Worth every cent.",
    author: "Marcus T., Portland OR",
  },
  {
    quote:
      "My husband cried. He said they tasted like 1994. I ordered two more boxes that same evening.",
...
export default function Home() {
  ...
  const churros = products.find(
    (p) => p.category === "churros" && p.available !== false,
  );
  ...
  return (
    <div style={{ fontFamily: "var(--font-sans)" }}>
      ...
      <section className="relative bg-white overflow-hidden">
        {/* Castle backdrop */}
        <div
          className=" absolute left-1/2 top-[22%] sm:top-[12%] sm:aspect-8/3 sm:w-[75%] -translate-x-1/2 w-[125%] aspect-4/3 opacity-20 pointer-events-none"
          aria-hidden="true"
        >
          <Image
            src="/castle.png"
          ...
          {/* Readability overlay */}
          <div className="absolute inset-0 bg-gradient-to-b from-cream-50/80 via-cream-50/55 to-cream-50/90" />
        </div>
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse 85% 65% at 75% 30%, #faf7f0 0%, rgba(250,247,240,0) 62%), radial-gradient(ellipse 65% 45% at 10% 90%, rgba(201,150,44,0.07) 0%, rgba(201,150,44,0) 60%)",
          }}
          aria-hidden="true"
        />
        ...
        <svg
          className="
      hero-curve absolute bottom-0 left-0
      w-full h-20 sm:h-32
      text-navy-600/10
      pointer-events-none
    "
        ...
        >
          <path
            d="M0,60 C240,110 480,10 720,50 C960,90 1200,20 1440,65"
            stroke="currentColor"
            strokeWidth="2"
          />
        </svg>
      ...
      "
        ...
        "
              style={{
                ...
                fontSize: "clamp(2.55rem, 8vw, 4.1rem)",
                letterSpacing: "-0.025em",
              }}
            >
              Bring the magic{" "}
              <em
                className="not-italic text-navy-600"
        ...
        "
            >
              Authentic 15-inch churros — the same style served at the theme
              parks — flash-frozen at peak freshness and shipped free to your
              door, for just $65 a dozen.
            </p>
        ...
        "
            ...
            bg-navy-600
            hover:bg-gold-500
            text-white hover:text-navy-950
            font-semibold text-[15px]
            transition-all duration-150
            hover:-translate-y-0.5
            hover:shadow-[0_14px_30px_-12px_rgba(201,150,44,0.7)]
          "
              >
                Shop Churros
                <ArrowIcon size={15} />
        ...
        "
            >
              ...
              <p className="text-[12px] sm:text-[13px] text-charcoal-700/50 font-medium">
    ...
    ========================== */}
      ...
      "
        ...
        "
              style={{
                background:
                  "radial-gradient(circle at 50% 48%, rgba(201,150,44,0.16) 0%, rgba(201,150,44,0.045) 45%, transparent 70%)",
              }}
              aria-hidden="true"
            />
            ...
            sm:h-[380px]
            md:h-[420px]
            lg:h-[clamp(360px,36vh,460px)]
            w-auto
            select-none
            drop-shadow-[0_30px_40px_rgba(11,18,38,0.18)]
          "
              />
            </div>
        ...
        "
          ...
          rounded-full
          px-4 py-2
          shadow-[0_10px_30px_-10px_rgba(11,18,38,0.25)]
        ...
        "
            >
              ...
              <span className="text-[11px] font-semibold text-charcoal-700/60">
                The real deal
              </span>
            </div>
          </div>
      ...
      <section className="bg-cream-200 border-y border-navy-600/8">
        <div className="max-w-6xl mx-auto px-5 sm:px-8 py-7">
          <div className="flex flex-col lg:flex-row items-center gap-5 lg:gap-10">
            ...
            <div
              className="hidden lg:block h-8 w-px bg-navy-600/15"
              aria-hidden="true"
            />
            <div className="grid grid-cols-2 md:grid-cols-4 gap-x-5 gap-y-6 lg:gap-8 w-full">
              {trustPoints.map((t) => (
                <div key={t.label} className="flex items-start gap-2.5">
                  ...
                  <div>
                    <p className="text-[13px] font-semibold text-charcoal-700 leading-tight">
                      {t.label}
                    </p>
                    <p className="text-[11.5px] text-charcoal-700/50 leading-snug mt-0.5 hidden sm:block">
                      {t.note}
                    </p>
                  </div>
                </div>
      ...
      {/* ══ FEATURED PRODUCTS ══ */}
      <section className="bg-cream-100 py-14 sm:py-24 px-5 sm:px-8">
        <div className="max-w-6xl mx-auto">
          <RevealBlock>
            <div className="flex items-end justify-between gap-5 mb-8 sm:mb-12">
              <SectionHeader
          ...
          <div className="mt-8 sm:hidden">
            ...
            >
              ...
              <ArrowIcon
                size={14}
                className="inline-block ml-1.5 transition-transform duration-200 group-hover:translate-x-1"
              />
            </button>
          </div>
        </div>
      ...
      {/* ══ BUNDLES / AOV ══ */}
      <section className="bg-white py-14 sm:py-24 px-5 sm:px-8 overflow-hidden">
        <div className="max-w-6xl mx-auto">
          <RevealBlock>
          ...
          {churros && (
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 sm:gap-5 lg:gap-7 max-w-4xl mx-auto">
              {BUNDLES.map((b) => (
                <BundleCard
                  key={b.dozens}
                  bundle={b}
          ...
          <p className="text-center text-[13px] text-charcoal-700/45 mt-8">
            ...
            <button
              onClick={() => go("/contact")}
              className="font-semibold text-navy-600 hover:text-gold-700 transition-colors underline underline-offset-2"
            >
              call for a quote
            </button>
            .
      ...
      <section
        id="story"
        className="bg-cream-100 py-14 sm:py-28 px-5 sm:px-8 overflow-hidden"
      >
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <RevealBlock>
              <div className="relative">
                ...
                <div className="absolute -bottom-6 left-4 w-36 sm:-bottom-8 sm:left-6 sm:w-56 rounded-2xl overflow-hidden border-4 border-cream-100 shadow-2xl">
            ...
            <div>
              ...
              <RevealBlock delay={0.08}>
                <p className="text-charcoal-700/60 leading-relaxed text-[15px] mt-6 max-w-lg">
                  In the mid-1980s, a simple golden pastry rolled in warm
                  cinnamon sugar quietly became one of the most beloved snacks
                  in the world. Long, crisp on the outside, impossibly soft
                  within — the churro wasn&apos;t just food. It became part of
                  the experience itself. The crackle of that first bite, the
                  sugar dust on your fingers, the line that felt worth every
                  minute.
                </p>
                <p className="text-charcoal-700/60 leading-relaxed text-[15px] mt-4 mb-8 max-w-lg">
                  Millions of guests have enjoyed that same iconic churro over
                  the years. Uncle Walt&apos;s lets you bring that exact
                  theme-park moment home — flash-frozen at peak freshness,
              ...
              <RevealBlock delay={0.12}>
                <ul className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-3.5 mb-9">
                  {[
                    ...
                    >
                      <span
                        className="text-gold-600 text-sm leading-snug mt-px"
                        aria-hidden="true"
                      >
                        ✓
                      </span>
              ...
              <RevealBlock delay={0.16}>
                <p className="text-charcoal-700/40 text-[13px] mt-4">
                  Skip the park lines. Park-quality churros, delivered to your
                  door.
                </p>
              </RevealBlock>
            </div>
      ...
      <section className="relative bg-navy-600 overflow-hidden">
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse 55% 90% at 85% 50%, rgba(201,150,44,0.12) 0%, transparent 65%)",
          }}
          aria-hidden="true"
        />
        ...
        <div className="relative max-w-4xl mx-auto px-5 sm:px-8 py-16 sm:py-24 text-center">
          ...
          <p className="text-white/70 text-[15px] sm:text-base leading-relaxed mt-5 max-w-xl mx-auto text-pretty">
            ...
            — flash-frozen and waiting in your freezer for whenever you&apos;re
            ready.
          </p>
          <button
            onClick={() => go("/shop")}
      ...
      {/* ══ HOW IT WORKS ══ */}
      <section className="bg-white py-14 sm:py-24 px-5 sm:px-8">
        <div className="max-w-6xl mx-auto">
          <RevealBlock>
            <div className="flex flex-col items-center text-center mb-10 sm:mb-14">
              <SectionHeader
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-10">
            {steps.map((step, i) => (
              <RevealBlock key={step.n} delay={i * 0.1} className="h-full">
                <div className="relative h-full flex flex-col items-center text-center rounded-3xl border border-navy-600/10 bg-cream-100 px-6 py-8 sm:py-10">
                  <span
                    className="absolute top-5 right-6 text-[44px] font-semibold text-navy-600/8 leading-none"
                    style={{ fontFamily: "var(--font-display)" }}
                    aria-hidden="true"
                  >
                    {step.n}
                  ...
                  {i < 2 && (
                    <span
                      className="hidden md:flex absolute top-1/2 -right-5 -translate-y-1/2 text-gold-500"
                      aria-hidden="true"
                    >
                      <ArrowIcon size={18} />
                    </span>
      ...
      <section className="bg-cream-100 py-14 sm:py-24 px-5 sm:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.15fr] gap-9 lg:gap-14 items-center">
            <RevealBlock>
              <SectionHeader
              ...
              <button
                onClick={() => go("/cooking")}
                className="mt-7 inline-flex items-center gap-2 h-12 px-7 rounded-full bg-navy-600 hover:bg-gold-500 text-white hover:text-navy-950 font-semibold text-[14.5px] transition-all duration-150 hover:-translate-y-0.5"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5 lg:gap-7">
            {testimonials.map((t, i) => (
              <RevealBlock key={i} delay={i * 0.1} className="h-full">
                <figure className="h-full flex flex-col rounded-3xl bg-cream-100 border border-navy-600/10 p-6 sm:p-7">
                  ...
                  <figcaption className="mt-5 pt-4 border-t border-navy-600/8 flex items-center gap-3">
                    ...
                    <span className="text-[13px] font-semibold text-charcoal-700/70">
                      {t.author}
                    </span>
                  </figcaption>
                </figure>
      ...
      {/* ══ FAQ ══ */}
      <section id="faq" className="bg-cream-100 py-14 sm:py-24 px-5 sm:px-8">
      ...
      {/* ══ FINAL CTA ══ */}
      <section className="bg-cream-200 py-16 sm:py-24 px-5 sm:px-8 overflow-hidden relative">
        ...
        <div className="relative max-w-3xl mx-auto text-center">
          <RevealBlock>
            ...
            <p className="text-charcoal-700/60 text-[15px] sm:text-base leading-relaxed mt-5 max-w-lg mx-auto text-pretty">
              Free shipping. Cash on delivery available. Frozen at peak
              freshness, ready whenever you are — just $65 a dozen.
            </p>
